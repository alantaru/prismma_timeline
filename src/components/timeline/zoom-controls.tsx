...
export function ZoomControls({ zoom, setZoom, onIntelligentZoom, isAiLoading }: ZoomControlsProps) {
  ...
  return (
    <div className="absolute bottom-4 right-4 z-10 p-2 bg-background/80 backdrop-blur-md rounded-lg border border-border shadow-2xl flex items-center gap-4">
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="ghost" size="icon" onClick={onIntelligentZoom} disabled={isAiLoading}>
